...
--
-- Name: idx_audit_entries_new_data; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_audit_entries_new_data ON public.audit_entries USING gin (new_data);


--
-- Name: idx_audit_entries_old_data; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_audit_entries_old_data ON public.audit_entries USING gin (old_data);
